<?php
	...
	$result = $sponsC->getSponsorById($_GET['id']);


    if (isset($_POST['nom']) && isset($_POST['societe']) && isset($_POST['duree'])) {
        //echo $_POST['nom'];
        require_once '../Model/sponsor.php';
        $sponsor = new Sponsors($result['id'],$_POST['nom'],$_POST['societe'],(float)$_POST['duree']);
        //echo $publicite->getNom();
        $sponsC->updateSponsor($sponsor,$result['id']);
    ...
    <div class="shell">
      ...
      <div class="box">
                ...
                <div class="row">
                    ...
                    <div class="col-75">
                        <input type="text" name = "societe" value = "<?= $result['societe'] ?>">
                    </div>
                </div>
                <div class="row">
                    <div class="col-25">
                    ...
                    <div class="col-75">
                        <input type="number" name = "duree" value = "<?= $result['duree'] ?>">
                    </div>
                </div>
                <br>
                <div class="row">
